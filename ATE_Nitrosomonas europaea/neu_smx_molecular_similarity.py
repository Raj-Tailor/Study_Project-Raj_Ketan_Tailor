...
output_file_path = os.path.join(current_dir, 'neu_smx_similarity_results.xlsx')
...
output_sorted_file_path = os.path.join(current_dir, 'neu_smx_similarity_results_sorted.xlsx')

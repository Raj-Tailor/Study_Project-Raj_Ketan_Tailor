...
output_file_path = os.path.join(current_dir, 'tvs_ate_similarity_results.xlsx')
...
output_sorted_file_path = os.path.join(current_dir, 'tvs_ate_similarity_results_sorted.xlsx')

...
output_file_path = os.path.join(current_dir, 'ajn_ibp_similarity_results.xlsx')
...
output_sorted_file_path = os.path.join(current_dir, 'ajn_ibp_similarity_results_sorted.xlsx')
